...
int main() {
	...
	float vertices[] = {
		...
		-0.5f, -0.5f, -0.5f,  0.0f, 1.0f, 0.0f, // Atrás
		 0.5f, -0.5f, -0.5f,  0.0f, 1.0f, 0.0f,
		 0.5f,  0.5f, -0.5f,  0.0f, 1.0f, 0.0f,
		 0.5f,  0.5f, -0.5f,  0.0f, 1.0f, 0.0f,
		-0.5f,  0.5f, -0.5f,  0.0f, 1.0f, 0.0f,
		...
		-0.5f, -0.5f, -0.5f,  0.5f, 0.0f, 0.5f, // Atrás
		0.5f, -0.5f, -0.5f,  0.5f, 0.0f, 0.5f,
		0.5f,  0.5f, -0.5f,  0.5f, 0.0f, 0.5f,
		0.5f,  0.5f, -0.5f,  0.5f, 0.0f, 0.5f,
		-0.5f,  0.5f, -0.5f,  0.5f, 0.0f, 0.5f,
		...
		-0.5f,  0.5f,  0.5f,  0.0f, 0.0f, 0.0f,
		-0.5f,  0.5f, -0.5f,  0.0f, 0.0f, 0.0f,
		// Para cada cubo adicional, añade más bloques de 36 vértices con el mismo esquema de color verde
	};
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//pata 1
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.1f, 0.4f, 0.1f)); //tamaño
