//MONTES SUAREZ MANUEL ALEJANDRO PRACTICA 7 ILUMINACION 1 FECHA DE ENTREGA 04/10/2024
// Std. Includes
#include <string>
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Materiales e Iluminacion Montes Suarez Manuel Alejandro", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shineses"), 0.6f);
