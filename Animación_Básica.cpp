...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion basica Montes Suarez Manuel Alejandro", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, glm::radians(angulo), glm::vec3(0.0f, -1.0f, 0.0f)); //hombro
