//MONTES SUAREZ MANUEL ALEJANDRO GRUPO 1 LABORATORIO DE COMPUTACIÓN GRAFICA
//PRACTICA 4 "Modelo Jerarquico"
...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Modelado jerarquico MONTES SUAREZ MANUEL ALEJANDRO", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//model dedo 2 contanuacion del 1
		model = glm::translate(modelTemp, glm::vec3(0.5f, 0.0f, 0.f));
		...
		//model dedo 2
		model = glm::translate(modelTemp, glm::vec3(0.25f, 0.0f, -0.375f));
		model = glm::rotate(model, glm::radians(dedo3), glm::vec3(0.0f, 0.0, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(-0.25f, -0.05f, -0.05f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(0.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//model dedo 3 contanuacion del 2
		model = glm::translate(modelTemp, glm::vec3(0.5f, 0.0f, 0.f));
		model = glm::rotate(model, glm::radians(dedo2), glm::vec3(0.0f, 0.0, 1.0f));
		model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		...
		//model dedo 5 contanuacion del 4
		model = glm::translate(modelTemp, glm::vec3(0.5f, 0.0f, 0.f));
		model = glm::rotate(model, glm::radians(dedo2), glm::vec3(0.0f, 0.0, 1.0f));
		model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		...
		model = glm::rotate(model, glm::radians(dedo1), glm::vec3(0.0f, 0.0, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.5f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(0.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//model dedo 6 contanuacion del 5
		model = glm::translate(modelTemp, glm::vec3(0.5f, 0.0f, 0.f));
		model = glm::rotate(model, glm::radians(dedo2), glm::vec3(0.0f, 0.0, 1.0f));
		model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
